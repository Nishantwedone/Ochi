    ...
    <div className="w-full h-screen flex gap-10 bg-zinc-300">
      <div className="w-1/2 h-full p-20 flex flex-col justify-between">
        <div className="heading">
          ...
          <h1 className='text-[6vw] uppercase leading-none text-black font-semibold tracking-tighter  font-["Founders Grotesk"]'>
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2 text-black p-20">
        <h1 className='text-[6vw] uppercase leading-none text-black -mb-5 font-semibold tracking-tighter  font-["Founders Grotesk"]'>
          presentations
        </h1>
        ...
        <div className="text flex items-end justify-between">
          <div className="mt-10">
            {["S:", "instagram", "behance", "facebook", "linkedin"].map(
              (item, index) => (
                ...
                <a
                  key={index}
                  className={`text-[1.1vw] capitalize font-light block ${
                    index === 0 && "mb-4"
                  }`}
                >
                  {item}
            ...
            {["L:", "202-1965 W 4th Ave", "Vancouver, Canada"].map(
              (item, index) => (
                <a
                  key={index}
                  className={`text-[1.1vw] capitalize font-light block ${
            ...
            {["30 Chukarina St", "Lviv, Ukraine"].map((item, index) => (
              <a key={index} className={`text-[1.1vw]g capitalize font-light block ${index === 0 && "mt-8"}`}>{item}</a>
            ))}
          ...
          <div className="mb-20 flex-col items-end justify-end ">
            ...
            {/* {["Website by Nishant"].map((item, index) => (
              <a key={index} className={`text-[1.1vw]g capitalize font-light block `}>{item}</a>
            ))} */}
          </div>
        </div>
      </div>
